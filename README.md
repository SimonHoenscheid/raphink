...
- [camptocamp/docker-g10k-webhook](https://github.com/camptocamp/docker-g10k-webhook) -  (6 days ago)
...
- [hashicorp/terraform](https://github.com/hashicorp/terraform) ([v0.14.0-alpha20200910](https://github.com/hashicorp/terraform/releases/tag/v0.14.0-alpha20200910), 3 days ago) - Terraform enables you to safely and predictably create, change, and improve infrastructure. It is an open source tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
- [rouge-ruby/rouge](https://github.com/rouge-ruby/rouge) ([v3.23.0](https://github.com/rouge-ruby/rouge/releases/tag/v3.23.0), 5 days ago) - A pure Ruby code highlighter that is compatible with Pygments
