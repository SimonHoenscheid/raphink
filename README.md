...
- [camptocamp/k8s-demo](https://github.com/camptocamp/k8s-demo) - An all-in-one Kubernetes demo using ArgoCD as a base component (2 days ago)
...
- [camptocamp/puppet-postfix](https://github.com/camptocamp/puppet-postfix) - Puppet postfix module (2 days ago)
- [camptocamp/puppet-selinux](https://github.com/camptocamp/puppet-selinux) -  (3 days ago)
...
- [camptocamp/bivac](https://github.com/camptocamp/bivac) ([2.3.2](https://github.com/camptocamp/bivac/releases/tag/2.3.2), 3 days ago) - 🏕 📦 Backup Interface for Volumes Attached to Containers
- [hashicorp/terraform](https://github.com/hashicorp/terraform) ([v0.13.4](https://github.com/hashicorp/terraform/releases/tag/v0.13.4), 4 days ago) - Terraform enables you to safely and predictably create, change, and improve infrastructure. It is an open source tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
- [camptocamp/k8s-demo](https://github.com/camptocamp/k8s-demo) ([v0.2.0](https://github.com/camptocamp/k8s-demo/releases/tag/v0.2.0), 2 weeks ago) - An all-in-one Kubernetes demo using ArgoCD as a base component
