...
- [ripienaar/puppet-catalog-diff](https://github.com/ripienaar/puppet-catalog-diff) - Tool to diff Puppet catalogs (today)
...
- [voxpupuli/puppetboard](https://github.com/voxpupuli/puppetboard) ([v2.2.0](https://github.com/voxpupuli/puppetboard/releases/tag/v2.2.0), 3 days ago) - Web frontend for PuppetDB
...
- [Simple secret sharing with gopass and summon](https://dev.to/camptocamp-ops/simple-secret-sharing-with-gopass-and-summon-40jk) (6 days ago)
