...
- [rouge-ruby/rouge](https://github.com/rouge-ruby/rouge) ([v3.23.0](https://github.com/rouge-ruby/rouge/releases/tag/v3.23.0), today) - A pure Ruby code highlighter that is compatible with Pygments
- [hashicorp/terraform](https://github.com/hashicorp/terraform) ([v0.13.2](https://github.com/hashicorp/terraform/releases/tag/v0.13.2), 6 days ago) - Terraform enables you to safely and predictably create, change, and improve infrastructure. It is an open source tool that codifies APIs into declarative configuration files that can be shared amongst team members, treated as code, edited, reviewed, and versioned.
